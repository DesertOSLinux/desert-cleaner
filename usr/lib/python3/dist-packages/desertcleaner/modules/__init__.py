...
from desertcleaner.settings.debug import log_traceback
...
class ModuleLoader:
    ...
    def __init__(self, feature, user_only=False):
        ...
        if not user_only:
            ...
            try:
                m = __import__('desertcleaner.%s' % self.feature, fromlist='desertcleaner')
    ...
    def is_module_active(cls, k, v):
        from desertcleaner.janitor import JanitorPlugin
        try:
